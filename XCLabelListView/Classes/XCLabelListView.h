...
/** 👀 内容在 X 轴方向上的偏移量：默认 15(左右各留 15) 👀 */
@property (assign, nonatomic) IBInspectable CGFloat contentInsetsX;
/** 👀 正常状态下的文字颜色 👀 */
...
@property (copy, nonatomic) void(^didFetchContentHeightBlock)(XCLabelListView *listView, CGFloat contentH);

/** 👀 当选中某个下标的回调 👀 */
@property (copy, nonatomic) void(^didSelectItemBlock)(XCLabelListView *listView, NSInteger idnex);
